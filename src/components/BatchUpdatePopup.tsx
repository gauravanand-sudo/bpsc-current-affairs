  ...
  return (
    <aside className="batch-popup" aria-label="Batch update">
      ...
      <div className="batch-fees">
        <span><b>UPSC 2027</b><strong>₹1,60,000</strong></span>
        <span><b>73rd BPSC</b><strong>₹87,000</strong></span>
      </div>
