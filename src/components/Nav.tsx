  ...
  return (
    <>
      <div className="institute-strip">
        ...
        <b>UPSC 2027 · 73rd BPSC · Foundation to Interview</b>
        <span className="fees">UPSC ₹1.60L · BPSC ₹87K</span>
      </div>
      <nav className="main-nav" aria-label="Primary navigation">
        <Link href="/" className="brand" aria-label="OneShot GS home"><Image src="/logo3.png" alt="OneShot GS UPSC and BPSC coaching" width={112} height={42} priority /></Link>
        <div className="desktop-nav">
          {desktopLinks.map(({ href, label }) => <Link key={href} href={href} className={isActive(href) ? "active" : ""}>{label}</Link>)}
        </div>
        <div className="nav-actions">
          <Link href="/demo" className="demo-link">Demo</Link>
