    ...
    <footer className="academic-footer">
      <div className="footer-inner">
        <div className="footer-intro">
          ...
          <div className="footer-actions"><Link href="/study">Start Free Study</Link><Link href="/quizzes" className="secondary">Take a Free Quiz</Link><Link href="/#courses" className="program">Explore Programs →</Link></div>
        </div>
      ...
      <div className="footer-bottom">
        ...
        <nav><Link href="/study">Free Study</Link><Link href="/quizzes">Free Quiz</Link><Link href="/pyq">PYQs</Link><Link href="/ask">Ask Tutor</Link><Link href="/partner">Study Buddy</Link><Link href="/#courses">Programs</Link></nav>
      </div>
      <style>{`
