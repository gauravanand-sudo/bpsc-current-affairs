    ...
    <main className="demo-page">
      <section className="demo-hero">
        <div className="shell hero-grid">
          <div>
            <span className="overline">DEMO CLASS · UPSC / BPSC POLITY</span>
            <h1>Basic Structure Doctrine: learn it for Prelims and write it for Mains.</h1>
            <p>This working OneShot GS sample shows the teaching sequence used across UPSC / BPSC preparation: concept → PYQ relevance → Mains structure → active recall → revision.</p>
            <div className="actions"><a href="#lesson" className="primary">Start Demo Lesson</a><Link href="/courses" className="secondary">View Flagship Programs</Link></div>
          </div>
      ...
      <section id="lesson" className="shell lesson-layout">
        <article className="lesson-main">
          ...
          <div className="lesson-block">
            ...
            <div className="next-actions"><Link href="/quizzes/static">Practice Static GS →</Link><Link href="/pyq">Open PYQ Intelligence Desk →</Link><Link href="/study">Continue Free Study →</Link></div>
          </div>
        </article>
