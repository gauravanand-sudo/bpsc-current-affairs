    ...
    <main className="pyq-page">
      <section className="hero">
        <div className="shell hero-grid">
          <div>
            ...
            <h1>Original papers, without leaving OneShot GS.</h1>
            <p>Open any UPSC Prelims year from 2014–2026 and read the complete General Studies Paper I directly on OneShot GS. The PDF is hosted with the site, so there is no UPSC iframe error and no external redirect.</p>
          ...
          <aside>
            ...
            <small>Original paper PDFs are stored in the OneShot GS repository and served from the OneShot GS domain.</small>
          </aside>
        </div>
      </section>
      ...
      <section id="upsc-prelims" className="shell papers">
        <header>
          ...
          <p>Each year opens a full-screen paper reader. Use the browser&apos;s native zoom, search, print and page controls.</p>
        </header>

        <div className="year-grid">
          {PRELIMS_YEARS.map((year) => (
            <Link key={year} href={`/pyq/upsc/prelims/${year}`} className="year-card">
              <div><span>UPSC PRELIMS</span><b>GS PAPER I</b></div>
              <h3>{year}</h3>
      ...
      <section id="bpsc" className="bpsc">
        <div className="shell bpsc-grid">
          <div>
            ...
            <p>The same local-paper format will be used for BPSC CCE Prelims and Mains papers so UPSC / BPSC preparation stays inside one library.</p>
          </div>
