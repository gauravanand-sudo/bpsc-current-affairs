    ...
    <main className="faculty-page">
      <section className="hero">
        <div className="shell hero-grid">
          ...
          <aside><span>13-PERSON ACADEMIC TEAM</span><b>Teach → Mentor → Review → Interview</b><p>Clear ownership across subjects, test strategy, study planning, answer evaluation and the Personality Test.</p></aside>
        </div>
      </section>

      <section className="shell section">
        <header><div><span className="overline">FACULTY, MENTORS & GUIDANCE</span><h2>Meet the complete academic team.</h2></div><p>Every profile has a defined role, subject responsibility and learner-support focus.</p></header>
        <div className="team-strip" aria-label="Academic team composition">
          <span><b>8</b> Subject faculty</span>
          <span><b>3</b> Strategy & mains mentors</span>
          <span><b>1</b> Academic counsellor</span>
          <span><b>1</b> Interview panel mentor</span>
        </div>
        <div className="faculty-grid">
          {FACULTY.map(f => (
            <article key={f.name} data-team={f.role}>
              <div className="photo"><Image src={f.image} alt={`${f.name}, ${f.subject}`} width={360} height={450} sizes="(max-width: 520px) 100vw, (max-width: 800px) 50vw, 33vw" /></div>
      ...
      <section className="guest-wrap"><div className="shell guest"><div className="guest-mark">IPS</div><div><span className="overline light">SPECIAL GUEST LECTURE</span><h2>Narayanan Sir · Retd. IPS</h2><p>Administration, Ethics and Decision-Making for UPSC/BPSC Mains and Interview, bringing public-service perspective into classroom discussion and interview preparation.</p><div className="tags"><span>Ethics</span><span>Administration</span><span>Mains</span><span>Interview</span></div></div><Link href="/courses">Explore Complete Programs →</Link></div></section>
