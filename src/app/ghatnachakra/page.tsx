...
const SUBJECTS = [
  { key: "polity",      label: "Polity & Governance",       emoji: "⚖️",  yt: "", pdf: "" },
  { key: "economics",   label: "Economics",                  emoji: "📊",  yt: "", pdf: "" },
  { key: "geography",   label: "Geography",                  emoji: "🗺️", yt: "", pdf: "" },
  { key: "history",     label: "History & Culture",          emoji: "🏛️", yt: "", pdf: "" },
  { key: "environment", label: "Environment & Ecology",      emoji: "🌿",  yt: "", pdf: "" },
  { key: "st",          label: "Science & Technology",       emoji: "🔬",  yt: "", pdf: "" },
  { key: "ir",          label: "International Relations",    emoji: "🌍",  yt: "", pdf: "" },
  { key: "social",      label: "Social Issues",              emoji: "🤝",  yt: "", pdf: "" },
  { key: "bihar",       label: "Bihar Special",              emoji: "🏵️", yt: "", pdf: "" },
];
    ...
    <main style={{ minHeight: "100vh", background: "var(--bg)", color: "var(--ink)" }}>
      ...
      <section style={{
        ...
        <p style={{
          ...
          Subject-wise video lectures & PDF notes for complete GS preparation
        </p>
      ...
      <style>{`
        ...
        @media (min-width: 780px) {
          .subjects-grid { grid-template-columns: 1fr 1fr 1fr; }
        }
