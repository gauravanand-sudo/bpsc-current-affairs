...
const CONTENT = [
  { href: "/ca/lectures", code: "CA", title: "Current Affairs", desc: "Source-backed current-affairs desk, issue tracking and revision workflow for UPSC & BPSC.", meta: "Official sources · Revision" },
  ...
  { href: "/pyq", code: "PY", title: "UPSC & BPSC PYQs", desc: "Official-source previous papers organised for pattern analysis, revision and practice.", meta: "UPSC · BPSC · Official sources" },
];
...
const METHOD = [
  ...
  ["03", "Practice every week", "Use official PYQs and Free Quiz sets to test recall, elimination and weak areas."],
        ...
        <div className="study-shell">
          ...
          <div className="hero-grid">
            <div>
              ...
              <div className="hero-actions"><a href="#library" className="primary">Browse Free Library</a><Link href="/quizzes" className="secondary">Take a Free Quiz →</Link><Link href="/demo" className="text-link">Demo Class →</Link></div>
            </div>
            <aside className="free-note"><span>FREE ACCESS</span><strong>Study before you enroll.</strong><p>Use the open library, quizzes and official-source PYQs first. Complete programs add sequencing, tests, answer-writing evaluation, mentoring and Interview guidance.</p></aside>
          </div>
        </div>
      </section>
